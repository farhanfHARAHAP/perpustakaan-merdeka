        ...
        <?php include 'alert.php'; ?>       
            <div class="container-fluid">                
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Pilih Member Peminjam</h3>
                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                    <?php
                                    $url = $host.'/member.php?action=selectMemberAll&mode=JSON';
                                    ...
                                    if($fetchResult['response'] == 200){
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['category'] ?></td>
                                            <td><?= $row['address'] ?></td>                                            
                                            <td><a href="./lend-book.php?member_id=<?= $row['id'] ?>"><i class="icon-target"></i> Pilih </a></td>   
                                        </tr>  
                                    <?php }
                                    }
                                    ?>                                                                                                                                                           
