        ...
        <?php include 'alert.php'; ?>        
            <div class="container-fluid">                
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Pilih Peminjaman Buku</h3>                            
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    if($fetchResult['response'] == 200){
                                        for($i=0; $i<count($fetchResult['data']);$i++){ 
                                            ...
                                            if($row['returned'] == 0){ // Not returned
                                        ?>                                                                                
                                        <tr>                                                                                       
                                            <td><?= $row['date'] ?></td>                                                  
                                            <td><?= $row['member'] ?></td>     
                                            ...
                                            <td>
                                                <a href="./return-lend-confirm.php?lend_id=<?= $row['id'] ?>"><i class="icon-action-undo"></i> Pilih </a><br>
                                            </td>  
                                        </tr>  
                                    <?php }
                                        }
