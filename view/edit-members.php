        ...
        <?php include 'alert.php'; ?>  
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Mengedit Member</h3>
                            <p class="text-muted m-b-30 font-13"> Isi form dengan baik dan benar! </p>
                            <p class="text-right">
                                <a href="<?=$host?>/member.php?action=deleteMember&id=<?=$_GET['id']?>&mode=PHP" class="btn btn-danger">Hapus Data</a>
                            </p>
                            <?php // Get Target Data to be Edited
                                include './request-links.php';
                                $url = $host.'/member.php?action=selectMemberByID&id='.$_GET['id'].'&mode=JSON';
                                ...
                                $data = $result['data'][0];
                            ?>
                            <form class="form-horizontal" action="<?=$host?>/member.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <?php
                                            $url = $host.'/member_category.php?action=selectMemberCategoryAll&mode=JSON';
