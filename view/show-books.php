        ...
        <?php include 'alert.php'; ?>    
            <div class="container-fluid">                
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Data Buku</h3>
                            <p class="text-muted m-b-30">Buku yang terdata di database.</p>
                            <div class="table-responsive">
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                    <?php
                                    $url = $host.'/book.php?action=selectBookAll&mode=JSON';
                                    ...
                                    if($fetchResult['response'] == 200){
                                        ...
                                        <tr>
                                            <td>
                                                <img src="<?= $row['image'] ?>" style="width: 100px; height: 180px">
                                            </td>
                                            <td><?= $row['code'] ?></td>
                                            <td><?= $row['name'] ?></td>
                                            <td><?= $row['author'] ?></td>                                            
                                            ...
                                            <td style="width: 200px;">
                                                <a href="./edit-books.php?id=<?= $row['id'] ?>"><i class="icon-pencil"></i> Edit </a><br>
                                                <a href="./duplicate-books.php?id=<?= $row['id'] ?>"><i class="icon-docs"></i> Duplicate </a>
                                            </td>                                                                                                                         
                                        </tr>  
                                    <?php }
                                    }
