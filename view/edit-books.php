...
session_start(); 
if(!isset($_GET['id'])){
    header('Location: ./show-members.php');
}
        ...
        <?php include 'alert.php'; ?>  
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Mengedit Buku</h3>
                            <p class="text-muted m-b-30 font-13"> Isi form dengan baik dan benar! </p>
                            <p class="text-right">
                                <a href="<?=$host?>/book.php?action=deleteBook&id=<?=$_GET['id']?>&mode=PHP" class="btn btn-danger">Hapus Data</a>
                            </p>
                            <?php // Get Target Data to be Edited
                                include './request-links.php';
                                $url = $host.'/book.php?action=selectBookByID&id='.$_GET['id'].'&mode=JSON';
                                ...
                                $data = $result['data'][0];
                            ?>                            
                            <form class="form-horizontal" action="<?=$host?>/book.php" method="POST">
                                ...
                                <div class="form-group">  
                                    <label>Penulis / Penerbit Buku</label>                                  
                                    <input type="text" class="form-control" name="author" value="<?=$data['author']?>">
                                </div>            
                                <div class="form-group">    
                                    <label>Tanggal Terbit</label>                                
                                    <input type="text" class="form-control" placeholder="YYYY-MM-DD" name="release" value="<?=$data['release']?>">
                                </div>                                                                     
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <?php
                                            $url = $host.'/book_category.php?action=selectBookCategoryAll&mode=JSON';
