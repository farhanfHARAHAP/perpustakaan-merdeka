        ...
        <?php include 'alert.php'; ?>    
            <div class="container-fluid">                
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Buku Dipinjam</h3>
                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                    <?php
                                    $url = $host.'/book.php?action=selectBookLend&mode=JSON';
                                    ...
                                    if($fetchResult['response'] == 200){
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 200px;">                                                
                                                <a href="./lend-date.php?book_id=<?= $row['id'] ?>&member_id=<?= $_GET['member_id'] ?>"><i class="icon-target"></i> Pilih </a>
                                            </td>                                                                                                                         
                                        </tr>  
                                    <?php } 
                                        }
